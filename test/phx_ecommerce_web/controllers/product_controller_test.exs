defmodule PhxEcommerceWeb.ProductControllerTest do
  use PhxEcommerceWeb.ConnCase

  import PhxEcommerce.CatalogFixtures

  @create_attrs %{description: "some description", title: "some title", price: "120.5", image_path: "some image_path"}
