defmodule PhxEcommerceWeb.UserAuthTest do
  use PhxEcommerceWeb.ConnCase, async: true

  alias PhxEcommerce.Accounts
  alias PhxEcommerce.Accounts.Scope
  alias PhxEcommerceWeb.UserAuth

  import PhxEcommerce.AccountsFixtures

  @remember_me_cookie "_phx_ecommerce_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhxEcommerceWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
